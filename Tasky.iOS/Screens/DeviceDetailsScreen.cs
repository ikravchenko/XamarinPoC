...
namespace BluetoothLEExplorer.iOS.UI.Screens.Scanner.DeviceDetails
{
	public partial class DeviceDetailsScreen : UIViewController
	{
		...
		public override void LoadView() {
			this.servicesTableView = new UITableView ();
			this.tableSource = new ServiceTableSource ();
			this.View = servicesTableView;

			this.tableSource.ServiceSelected += (object sender, ServiceTableSource.ServiceSelectedEventArgs e) => {
				this._serviceDetailsScreen = new BluetoothLEExplorer.iOS.UI.Screens.Scanner.ServiceDetails.ServiceDetailsScreen() as ServiceDetails.ServiceDetailsScreen;
			...
			this.tableSource.Services = this._services;
			this.servicesTableView.Source = this.tableSource;
		...
		protected class ServiceTableSource : UITableViewSource
		{
			...
			public override UITableViewCell GetCell (UITableView tableView, NSIndexPath indexPath)
			{
				...
				if (service.UUID.Equals(CBUUID.FromString(BluetoothAssistant.HRS_SERVICE_UUID))) {
