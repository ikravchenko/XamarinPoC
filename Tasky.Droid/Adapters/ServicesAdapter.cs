...
namespace BluetoothLEExplorer.Droid
{
	public class ServicesAdapter : GenericAdapterBase<BluetoothGattService>
	{
		...
		public override View GetView(int position, View convertView, ViewGroup parent)
		{
			...
			if (items[position].Uuid.Equals(UUID.FromString(BluetoothAssistant.HRS_SERVICE_UUID))) {
				view.FindViewById<TextView>(Android.Resource.Id.Text1).Text = "Heart Rate Service";
			}
			return view;
		}
	}
